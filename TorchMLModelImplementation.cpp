...
//******************************************************************************
void TorchMLModelImplementation::AllocatePrivateParameterMemory()
{
...
int TorchMLModelImplementation::SetRefreshMutableValues(
...
//
int TorchMLModelImplementation::SetComputeMutableValues(
    KIM::ModelComputeArguments const * const modelComputeArguments,
...
//******************************************************************************
int TorchMLModelImplementation::GetComputeIndex(
...
//******************************************************************************
void TorchMLModelImplementation::ProcessVirialTerm(
    const double & dEidr,
    const double & rij,
...
//******************************************************************************
void TorchMLModelImplementation::ProcessParticleVirialTerm(
    const double & dEidr,
    const double & rij,
    const double * const r_ij,
    const int & i,
