#ifndef TORCHEXPORTMODEL_HPP
#define TORCHEXPORTMODEL_HPP
...
class TorchExportModel : public MLModel
{
 private:
 ...
 public:
  ...
  TorchExportModel(std::string & model_file_path,
  ...
  ~TorchExportModel() override = default;
};

#endif /* TORCHEXPORTMODEL_HPP */
