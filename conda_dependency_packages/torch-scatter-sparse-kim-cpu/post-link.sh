...
LIBTORCH_TAG="1.13.0"
TORCH_ARCHIVE="https://download.pytorch.org/libtorch/cpu/libtorch-cxx11-abi-shared-with-deps-1.13.0%2Bcpu.zip"

echo "Downloading LibTorch ${LIBTORCH_TAG} CPU …"
TMPDIR=$(mktemp -d)
...
echo "torch-scatter-sparse-kim-cpu installation completed."
